...
export default {
  ...
  data() {
    return {
      erc20: '0x964124F9371D11F95c4873266f4560919D8BcE46',
      selectedAddress: 'cosmos1ed7chd8s43pqxsphywlar55xxqwa396eavy8w6',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1ed7chd8s43pqxsphywlar55xxqwa396eavy8w6')
